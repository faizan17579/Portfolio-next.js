...
import { DeveloperEarth } from "@/components/developer-earth"
    ...
    <div className="min-h-screen bg-black py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-20 text-center relative">
          <div className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 rounded-2xl p-12 border border-purple-500/20 relative overflow-hidden backdrop-blur-sm">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center gap-3 mb-6">
                <MessageCircle className="h-16 w-16 text-purple-500 animate-bounce" />
